...
int address_match(const struct iphdr *iph, const ipfire_rule *r, int direction, const struct net_device *in, const struct net_device *out);
int port_match(const struct tcphdr *tcph, const struct udphdr *udph, const ipfire_rule *r, short protocol);
int ip_layer_filter(const struct iphdr *iph, const ipfire_rule *r, int direction, const struct net_device *in, const struct net_device *out);
