...
inline void fill_packet_with_name(ipfire_info_t *packet, const ipfire_rule *r);
...
int device_filter(const ipfire_rule *r, const struct net_device *in,
...
int ip_layer_filter(const struct iphdr *iph, const ipfire_rule *r,
...
inline int ixmp_match(const ipfire_info_t *packet,
                      const struct state_table *entry);

inline int direct_transport_state_match(const ipfire_info_t *packet,
                                        const struct state_table *entry);
inline int reverse_transport_state_match(const ipfire_info_t *packet,
                                         const struct state_table *entry);
