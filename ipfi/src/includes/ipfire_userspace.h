...
/* reads rules from a configuration file and allocates a dynamic vector
 * containing them */
...
int send_cmd_to_kernel(command mess, struct netl_handle *handle,
                       int type_of_message);
...
int print_packet(const ipfire_info_t *pack, const struct ipfire_servent *ipfise,
