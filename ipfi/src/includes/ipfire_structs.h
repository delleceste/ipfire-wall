...
#ifndef SHARE_CFGDIR
#define SHARE_CFGDIR "/usr/share/ipfire"
#endif
...
typedef struct {
  ...
  struct state_t stat;
  /* fields to compare */
  __u32 position : 1, device : 1, indevice : 1, outdevice : 1, nat : 1,
      masquerade : 1, snat : 1, dnat : 1, policy : 1, protocol : 1, tcp : 1,
      udp : 1, icmp : 1, direction : 1, in : 1, out : 1, fwd : 1, pre : 1,
      post : 1, port : 1,
      ip : 1, /* match ip or port, without distinguishing between src or dst */
              /* NOTE: added igmp support */
      state : 1, stateless : 1, sip : 1, dip : 1, sport : 1, dport : 1,
      igmp : 1, other : 4;

  __u16 setup : 1, setupok : 1, est : 1, finwait : 1, closewait : 1,
      lastack : 1, closed : 1, timewait : 1, free : 8;
...
struct cmdopts {
  u16 noflush_on_exit : 1, kloglevel : 3, loguser : 3, quiet : 1,
      user_allowed : 1, daemonize : 1, quiet_daemonize : 1,
